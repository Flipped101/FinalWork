...
public final class Grade implements Comparable<Grade>, Serializable {
    //定义私有字段
    private Integer id;
    ...
    //定义含有全部字段的构造器
    public Grade(Integer id, String description, String no,
    ...
    //定义不含有id字段的构造器
    public Grade(String description, String no,
                 String remarks, Department department) {
        super();
    ...
    public String toString() {
        ...
        retValue = "Grade ( "
                ...
                + "department_json = " + this.department + TAB
                + " )";
